...
def main(args):
  ...
  if 'bintoy' in DATASET:
    ...
    Xplus, Xminus = build_toy_dataset(1000, 3, 2, noise=True)
  ...
  if not grid_mode:
    ...
    for degree in tqdm(range(1, 5), "Building grid"):
      ...
      plot_classes(ax, model._data_classes, L=10)
      plot_polynomial_hypersurface_3d(ax, model._monomials, model._coeffs, L=25, sector_indicator=model._sector_indicator)
...
if __name__ == '__main__':
  ...
  parser.add_argument("dataset", type=str, choices=['iris', 'iris-binary', 'toy', 'toy-centers', 'toy-reverse', 'toy-centers-reverse', 'bintoy', 'bintoy-separated', 'bintoy-mixed'], help="Dataset to classify")
