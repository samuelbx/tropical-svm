...
\author{
Xavier Allamigeon\textsuperscript{1},
Samuel Boïté\textsuperscript{2},
Stéphane Gaubert\textsuperscript{1},
Théo Molfessis\textsuperscript{2}
}

\thanks{\textsuperscript{1}Inria and CMAP, École polytechnique, Palaiseau, France. \texttt{\{xavier.allamigeon, stephane.gaubert\}@inria.fr}}
\thanks{\textsuperscript{2}École polytechnique, Palaiseau, France. \texttt{\{samuel.boite, theo.molfessis\}@polytechnique.org}}
...
\subsubsection*{Tropical SVMs.} Gärtner and Jaggi \cite{gartner2008} introduced tropical SVMs using linear programming formulations. Their work introduced an elegant geometric approach to multi-class problems, since a single tropical hyperplane in dimension $d$ partitions the space into $d$ regions.
...
\subsubsection*{Background on Mean‐Payoff Games.}
...
\subsubsection*{Contributions.} We develop a new approach to tropical classification using mean-payoff games,
...
Code for fitting tropical SVMs and reproducing the figures and experiments is available online.\footnote{\url{https://github.com/samuelbx/tropical-svm}}
...
\subsubsection*{The Max-Plus Semiring.}
...
\subsubsection*{Hyperplanes and Sectors.}
...
\subsubsection*{Hilbert Seminorm.}
...
\subsubsection*{Convexity and Projections.}
...
\subsubsection*{Shapley Operators and Their Spectral Theory.}
...
\subsubsection*{Constructing the Classification Operator.}
...
\subsubsection*{Separating Point Clouds with a Hyperplane.}
...
\subsubsection*{Main Theorem: Spectral Radius and Margin.}
...
\subsubsection*{Benefits of the Spectral Approach.} 
...
\subsubsection*{Computing the Spectral Radius with Krasnoselskii--Mann Iterations.}
...
\subsubsection*{The Tropical SVM Algorithm.}\label{subsec:complete_algorithm}
...
\subsubsection*{Tropical Polynomial Kernel.}
...
\subsubsection*{Strategic Monomial Selection.}
...
\subsubsection*{Classification with Polynomials.}\label{subsec:poly_classification}
...
\subsubsection*{Margin Guarantees.}
...
\begin{figure}[ht!]
    ...
    \end{subfigure}\\[1em] % Adds a bit of space between the two subfigures
    \begin{subfigure}[t]{0.9\textwidth}
        \centering
    ...
    \end{subfigure}
    \caption{Comparison of polynomial classifiers.}
