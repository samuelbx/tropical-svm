...
\begin{abstract}
   ...
   Efficient computation of tropical separators has remained an open problem.
   ...
   It enables us to compute an optimal separating hyperplane via scalable iterative algorithms, with complexity linear in the size of the dataset and pseudo-polynomial in the desired precision.
