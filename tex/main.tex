...
\begin{figure}[!h]
    ...
    \begin{subfigure}{0.55\textwidth}
        ...
        \centering
    \clipbox{0.2\width{} 0.2\height{} 0.2\width{} 0.2\height{}}{\input{figures/bintoy-separated_1.pgf}}
}
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \resizebox{\linewidth}{!}{%
        \centering
            \clipbox{0.1\width{} 0.2\height{} 0.1\width{} 0.2\height{}}{\input{figures/circular_3.pgf}}
        }
    ...
    \begin{subfigure}{0.35\textwidth}
        ...
        \resizebox{\linewidth}{!}{%
        \centering
            \clipbox{0.1\width{} 0.1\height{} 0.1\width{} 0.1\height{}}{\input{figures/toy-reverse_3.pgf}}
        }
...
\begin{figure}[!h]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \resizebox{\linewidth}{!}{%
        \centering
            \clipbox{0.1\width{} 0.2\height{} 0.1\width{} 0.2\height{}}{\input{figures/circular_3_feature_eng.pgf}}}
