...
Then, the image of the second maximum operator $T$ is also included in this ball.
  It follows that any orbit of $T$ starting in this ball stays in this ball, and by Theorem~9 of~\cite{gaubert2004}, there exists a vector $a\in \R^n$ such that $T(a)=\rho(T)+a$.\todo{SG: existence proof added}
