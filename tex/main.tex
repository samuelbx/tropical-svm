...
and finally $\tilde{T}(a)=a$. We conclude by Theorem 16 in \cite{allamigeon_condition} that the intersection of convex hulls of both transformed point clouds, namely $\mathcal{S}(\tilde{T}^1) \cap \mathcal{S}(\tilde{T}^2)$, has empty interior.
\end{proof}
